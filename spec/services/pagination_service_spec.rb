...
describe PaginationService do
  ...
  describe '#links' do
    ...
    def make_url(page:, per_page:)
      "http://localhost:3000/api/v1/tokens?page=#{page}&per_page=#{per_page}"
    end
